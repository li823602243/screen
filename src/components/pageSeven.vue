  ...
  <div class="resource-wrapper">
    <div class="resource-left">
      ...
      <div class="resource-left--content">
        ...
        <el-row class="resource-left--body">
          <el-col :span="8">五星工程奖专题</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8" ><div class="resource-left--ranking resource-left--first"></div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">影视资源</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8" ><div class="resource-left--ranking resource-left--second"></div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">共享讲堂</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8" ><div class="resource-left--ranking resource-left--three"></div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">共享讲堂</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8"><div class="resource-left--ranking resource-left--other">4</div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">共享讲堂</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8" ><div class="resource-left--ranking resource-left--other">5</div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">共享讲堂</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8" ><div class="resource-left--ranking resource-left--other">6</div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">共享讲堂</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8" ><div class="resource-left--ranking resource-left--other">7</div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">共享讲堂</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8" ><div class="resource-left--ranking resource-left--other">8</div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">共享讲堂</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8" ><div class="resource-left--ranking resource-left--other">9</div></el-col>
        </el-row>
        <el-row class="resource-left--body">
          <el-col :span="8">共享讲堂</el-col>
          <el-col :span="8"> 15554</el-col>
          <el-col :span="8"><div class="resource-left--ranking resource-left--other">10</div></el-col>
        </el-row>
      </div>
    </div>
    <div class="resource">
    ...
    <div class="resource-right">
      ...
      <div class="resource-left--content">
        <div class="resource-pannel">
          <div class="r-pannel--header">
            <div class="p-header--left">
              <span class="p-header--icon p-header--first"></span>
              <span class="p-header--name p-name--first">第一名</span>
            </div>
            <span class="p-header--play">播放12254次</span>
          </div>
          <div class="r-pannel--content">上哪看熬时间段哦撒娇的熬时间段ASP多久啊店铺帕苏东坡</div>
        </div>
        <div class="resource-pannel">
          <div class="r-pannel--header">
            <div class="p-header--left">
              <span class="p-header--icon p-header--second"></span>
              <span class="p-header--name p-name--second">第二名</span>
            </div>
            <span class="p-header--play">播放12254次</span>
          </div>
          <div class="r-pannel--content">上哪看熬时间段哦撒娇的熬时间段ASP多久啊店铺帕苏东坡</div>
        ...
        <div class="resource-pannel">
          <div class="r-pannel--header">
            <div class="p-header--left">
              <span class="p-header--icon p-header--three"></span>
              <span class="p-header--name p-name--three">第三名</span>
            </div>
            <span class="p-header--play">播放12254次</span>
          </div>
          <div class="r-pannel--content">上哪看熬时间段哦撒娇的熬时间段ASP多久啊店铺帕苏东坡</div>
        ...
        <div class="resource-pannel">
          <div class="r-pannel--header">
            <div class="p-header--left">
              <span class="p-header--icon"></span>
              <span class="p-header--name">第一名</span>
            </div>
            <span class="p-header--play">播放12254次</span>
          </div>
          <div class="r-pannel--content">上哪看熬时间段哦撒娇的熬时间段ASP多久啊店铺帕苏东坡</div>
